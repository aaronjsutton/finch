...
FINCHD_RELEASE="0.23.3"
FINCHD_COMMIT="112eaef164062d61a03980ac0e749f37332b42d3"
...
NERDCTL_RELEASE="2.4.0-rc.0"
NERDCTL_COMMIT="e5d5ba67cc60466bc46ca35c6358be2c0f07ceb8"
NERDCTL_SRC=nerdctl-"${NERDCTL_COMMIT}"
NERDCTL_VERSION="v$(echo "$NERDCTL_RELEASE" | sed 's/-.*//')"

# buildkit
BUILDKIT_PACKAGE="github.com/moby/buildkit"
BUILDKIT_RELEASE="0.33.0"
BUILDKIT_COMMIT="dddd5621af04ea57823085c93a063383f71d3173"
...
SOCI_RELEASE="0.15.0"
SOCI_COMMIT="7716bd67e813f8e80873948e0a02d0a7c5370854"
...
CNI_RELEASE="1.9.1"
CNI_COMMIT="adc3e6b5b581638afbd194cf2e9319ecbb0151a1"
CNI_SRC=plugins-"${CNI_COMMIT}"

# cosign
COSIGN_PACKAGE="github.com/sigstore/cosign"
COSIGN_RELEASE="3.0.5"
COSIGN_COMMIT="479147a4df05f31be48aeb2b3a9d32dfc35ba877"
